...
const API_KEY = import.meta.env.VITE_GOOGLE_AI_API_KEY || "AIzaSyASSY9fkUZY2Q9cYsCd-mTMK0sr98lPh30";
    ...
    const handleUploadAndAnalyze = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://172.31.4.177:5050/analyze', {
                video_url: videoUrl,
                prompt: "Analyze this skin video for signs of skin cancer, including asymmetry, border irregularity, color variation, diameter changes, and evolution of lesions. Assess the severity and progression of any detected conditions. Include an Emergency Level (1 for high emergency, 2 for moderate emergency, 3 for low emergency) based on the severity of symptoms observed."
            });
