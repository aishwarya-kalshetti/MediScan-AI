...
function AnalysisBotXRAY() {
    ...
    const analyzeImage = async (imageUrl) => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/v1/analysis/xray', {
                method: 'POST',
                headers: {
            ...
            if (response.ok && data.success) {
                ...
                setAnalysis("Error: " + (data.message || "Unexpected response"));
            }
            // dispatch(addMedicalHistory(data.prediction, imageUrl)); // Commented out as it might fail if data.prediction is null
        } catch (error) {
