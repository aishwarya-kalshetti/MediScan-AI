...
const simplifyAnalysis = async (medicalAnalysis) => {
    ...
    try {
        const response = await fetch("http://localhost:5001/api/v1/analysis/simplify", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
            body: JSON.stringify({ analysis: medicalAnalysis }),
        });
        ...
        return data.simplifiedAnalysis;
    } catch (error) {
...
const analyzeImage = async (imageUrl) => {
    ...
    try {
        ...
        const base64Image = await new Promise((resolve, reject) => {
            ...
            reader.onloadend = () => {
                const result = reader.result; // Keep full dataURI
        ...
        const apiResponse = await fetch("http://localhost:5001/api/v1/analysis/skin", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
