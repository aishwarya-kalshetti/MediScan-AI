...
const Chat = () => {
    ...
    const doctorState = useSelector((state) => state.allDoctors) || {};
    ...
    // Effect for redirection mechanism
    useEffect(() => {
    ...
    // If not loading, but no user (and useEffect hasn't redirected yet)
    if (!user) {
                    ...
                    <div className="bg-white rounded-xl shadow-xl flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50">
                            {messages.map((msg, index) => (
                                ...
                                >
                                    <div
                                        className={`max-w-xs md:max-w-md rounded-2xl p-4 shadow-md ${msg.sender === socket.id
