...
const LoginSignup = () => {
    ...
    useEffect(() => {
        if (error) {
            ...
            // Optional: You could enable error toasts here too if desired
            // toast.error(error); 
        }

        if (isAuthenticated) {
            if (isSubmitting.current) {
                toast.success(authMode === "login" ? "Login Successful!" : "Signup Successful!");
                isSubmitting.current = false;
            }
            navigate("/account");
        }
    }, [dispatch, error, isAuthenticated, navigate, authMode]);
                                    ...
                                    <div className="pt-2">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            >
                                                ...
                                                <span
                                                    className={`text-center ${role === "patient" ? "text-black" : "text-blue-100"
                                                        }`}
                                                >
                                                    Patient
                                                </span>
                                            ...
                                            >
                                                ...
                                                />
                                                <div
                                                    className={`w-12 h-12 mb-2 rounded-full flex items-center justify-center ${role === "doctor" ? "bg-blue-500" : "bg-blue-700/50"
                                                        }`}
                                                >
                                                    <Stethoscope
                                                        size={24}
                                                ...
                                                <span
                                                    className={`text-center ${role === "doctor" ? "text-white" : "text-blue-100"
                                                        }`}
                                                >
                                                    Doctor
                                                </span>
