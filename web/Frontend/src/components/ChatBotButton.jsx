...
const ChatBotButton = () => {
  ...
  const API_URL = "http://localhost:5001/api/v1/chat";
          ...
          >
            <div className="space-y-4">
              {messages.map((message, index) => (
                ...
                >
                  <div
                    className={`max-w-[85%] rounded-2xl p-4 transition-all duration-200 ${message.type === "user"
                  ...
                  >
                    ...
                    <div
                      className={`text-xs mt-1.5 ${message.type === "user"
                        ? "text-indigo-200"
                        : "text-gray-500"
                        }`}
                    >
